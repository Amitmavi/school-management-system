...
import ChartsOverviewDemo from "../components/chartOverviewDemo/chartOverviewDemo"
import { Grid } from '@mui/material';
import { PieChart } from '@mui/x-charts/PieChart';
import './librarianDashboard.css'; // Import the CSS file
      ...
      <Main className="Main" open={open}>
        ...
        <Grid container spacing={2} style={{ marginTop: '20px' }}>
          <Grid item xs={12} sm={6} md={3}>
            {/* <div className="AdditionalCard" style={{ backgroundColor: "white", height: '200px' ,width:'190px'}}>
            <PieChart
              series={[
                {
                  data,
